...
snbt_path = r"d:\mc\mod\Prominence-II-Chinese\CNPack\config\ftbquests\quests\chapters\simply_swords.snbt"
...
def process_quest(quest_block, quest_idx, translations):
    base_key = f"ftbquests.chapter.simply_swords.quests{quest_idx}"
...
def process_chapter_properties(content, translations):
    ...
    base_key = "ftbquests.chapter.simply_swords"
...
def main():
    ...
    keys_to_remove = [k for k in data if k.startswith("ftbquests.chapter.simply_swords")]
